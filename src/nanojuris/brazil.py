...
_STATE_COURTS = [
    ...
    CourtInfo("TJAP", "Tribunal de Justica do Amapa", "state", "state", state="AP", official_url="https://www.tjap.jus.br/"),
    CourtInfo("TJBA", "Tribunal de Justica da Bahia", "state", "state", state="BA", official_url="https://www.tjba.jus.br/"),
    CourtInfo("TJCE", "Tribunal de Justica do Ceara", "state", "state", state="CE", official_url="https://www.tjce.jus.br/"),
    CourtInfo(
        "TJDFT",
    ...
    CourtInfo("TJES", "Tribunal de Justica do Espirito Santo", "state", "state", state="ES", official_url="https://www.tjes.jus.br/"),
    CourtInfo("TJGO", "Tribunal de Justica de Goias", "state", "state", state="GO", official_url="https://www.tjgo.jus.br/"),
    CourtInfo("TJMA", "Tribunal de Justica do Maranhao", "state", "state", state="MA", official_url="https://www.tjma.jus.br/"),
    CourtInfo("TJMG", "Tribunal de Justica de Minas Gerais", "state", "state", state="MG", official_url="https://www.tjmg.jus.br/"),
    CourtInfo(
        "TJMS",
    ...
    CourtInfo("TJMT", "Tribunal de Justica de Mato Grosso", "state", "state", state="MT", official_url="https://www.tjmt.jus.br/"),
    CourtInfo("TJPA", "Tribunal de Justica do Para", "state", "state", state="PA", official_url="https://www.tjpa.jus.br/"),
    CourtInfo("TJPB", "Tribunal de Justica da Paraiba", "state", "state", state="PB", official_url="https://www.tjpb.jus.br/"),
    CourtInfo("TJPE", "Tribunal de Justica de Pernambuco", "state", "state", state="PE", official_url="https://www.tjpe.jus.br/"),
    CourtInfo("TJPI", "Tribunal de Justica do Piaui", "state", "state", state="PI", official_url="https://www.tjpi.jus.br/"),
    CourtInfo("TJPR", "Tribunal de Justica do Parana", "state", "state", state="PR", official_url="https://www.tjpr.jus.br/"),
    CourtInfo("TJRJ", "Tribunal de Justica do Rio de Janeiro", "state", "state", state="RJ", official_url="https://www.tjrj.jus.br/"),
    CourtInfo("TJRN", "Tribunal de Justica do Rio Grande do Norte", "state", "state", state="RN", official_url="https://www.tjrn.jus.br/"),
    CourtInfo("TJRO", "Tribunal de Justica de Rondonia", "state", "state", state="RO", official_url="https://www.tjro.jus.br/"),
    CourtInfo("TJRR", "Tribunal de Justica de Roraima", "state", "state", state="RR", official_url="https://www.tjrr.jus.br/"),
    CourtInfo("TJRS", "Tribunal de Justica do Rio Grande do Sul", "state", "state", state="RS", official_url="https://www.tjrs.jus.br/"),
    CourtInfo("TJSC", "Tribunal de Justica de Santa Catarina", "state", "state", state="SC", official_url="https://www.tjsc.jus.br/"),
    CourtInfo("TJSE", "Tribunal de Justica de Sergipe", "state", "state", state="SE", official_url="https://www.tjse.jus.br/"),
    CourtInfo(
        "TJSP",
    ...
    CourtInfo("TJTO", "Tribunal de Justica do Tocantins", "state", "state", state="TO", official_url="https://www.tjto.jus.br/"),
]
